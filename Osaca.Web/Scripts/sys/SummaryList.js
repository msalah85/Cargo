...
var SummaryManager = function () {
    ...
    var
        ...
        CalcAmountDue = function (TotalInvoices, TotalPayments) {
            return ((TotalInvoices || 0) * 1) - ((TotalPayments || 0) * 1);
        },
        ...
        CallbackFunction = function (data) {
            ...
            //try {
                ...
                // bind lables.
                //$("#SpTotalInvoices").html(numeral(data.list4.TotalInvoices || 0).format('0,0.00'));
                //$("#SpTotalPayments").html(numeral(data.list4.TotalPayments || 0).format('0,0.00'));
